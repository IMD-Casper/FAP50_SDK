...
install:
	...
	@(cd $(DIR_SRC_LIB)/openjp2 && $(CP) ./bin/opj_decompress $(INSTALL_ROOT_BIN_DIR)/djp2k) || exit 1
	@(cd $(DIR_SRC_LIB)/openjp2 && $(CP) ./bin/opj_compress $(INSTALL_ROOT_BIN_DIR)/cjp2k) || exit 1
#
clean:
#
